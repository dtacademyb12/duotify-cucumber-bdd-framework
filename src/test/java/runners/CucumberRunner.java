...
@CucumberOptions (
        ...
        tags = "@signUp", // all scenarios tagged with @temp
...
//        tags = "not @signUp", // scenarios that DO NOT contain @signUp
        ...
        publish = true, // generate a cloud based html temporary report with a shareable link
        plugin = {
                "pretty", // adds more detailed info and logs in the command line output
